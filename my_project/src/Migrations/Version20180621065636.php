 ...
 */
final class Version20180621065636 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, posted TINYINT(1) NOT NULL, date_created DATETIME NOT NULL, publish_date DATETIME DEFAULT NULL, author VARCHAR(50) NOT NULL, cover_image VARCHAR(255) DEFAULT NULL, title VARCHAR(255) NOT NULL, content VARCHAR(255) DEFAULT NULL, hashtags LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', read_count SMALLINT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
