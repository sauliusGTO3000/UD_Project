 ...
 */
final class Version20180625105335 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE author (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(255) NOT NULL, birthday DATETIME NOT NULL, username VARCHAR(50) NOT NULL, email VARCHAR(180) NOT NULL, profile_picture VARCHAR(255) NOT NULL, password VARCHAR(72) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', is_active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_BDAFD8C8F85E0677 (username), UNIQUE INDEX UNIQ_BDAFD8C8E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
