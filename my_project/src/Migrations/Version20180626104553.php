 ...
 */
final class Version20180626104553 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post ADD author VARCHAR(50) NOT NULL COLLATE utf8mb4_unicode_ci, DROP author_id');
    }
}
